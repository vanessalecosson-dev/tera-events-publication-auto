...
layouts["tera-declic-eventplanning-s3"] = declicEP("declic-eventplanning-s3.png", 32, 3, [
  grp({ direction: "column", gap: 8, children: [
    t({ data: "tag_formule", font: "Poppins", weight: 700, size: 20, color: DECLIC_EP.accent, uppercase: true, nowrap: true }),
    { type: "titleTwoTone", dataNormal: "titre_normal", dataAccent: "titre_accent", font: "Playfair Display", weight: 500, size: 60, color: DECLIC_EP.text, accentColor: DECLIC_EP.accent, lineHeight: 1.15 }
  ]}),
...
layouts["tera-declic-eventplanning-s4"] = declicEP("declic-eventplanning-s4.png", 32, 4, [
  grp({ direction: "column", gap: 8, children: [
    t({ data: "tag_formule", font: "Poppins", weight: 700, size: 20, color: DECLIC_EP.accent, uppercase: true, nowrap: true }),
    { type: "titleTwoTone", dataNormal: "titre_normal", dataAccent: "titre_accent", font: "Playfair Display", weight: 500, size: 60, color: DECLIC_EP.text, accentColor: DECLIC_EP.accent, lineHeight: 1.15 }
  ]}),
...
layouts["tera-chiffremercredi-s1"] = chiffreRoot(
  { cx: 840.75, cy: 378, rx: 280, ry: 500, stops: ["rgba(26,59,139,1) 0%", "rgba(18,44,114,1) 50%", "rgba(9,28,88,1) 100%"] },
  [
    { type: "circle", x: -105, y: 1014, w: 280, color: CHIFFRE_C.accent2, opacity: 0.12 },
    { type: "audiolines", x: 870, y: 298, w: 157, h: 143, color: CHIFFRE_C.accent2, opacity: 0.6 },
    { type: "arrow", x: 1003, y: 1233, w: 42, color: "#ffffff" }
  ],
  16, [
    CHIFFRE_HEADER,
    grp({ direction: "column", align: "center", gap: 24, children: [
      t({ data: "chiffre", font: "Poppins", weight: 800, size: 260, color: CHIFFRE_C.accent, align: "center", nowrap: true, shadow: "0px 12px 30px rgba(0,0,0,0.16)" }),
      pill({ bg: "#ffffff", rotate: 3, padding: "10px 34px", children: [t({ data: "unite", font: "Poppins", weight: 800, size: 42, color: CHIFFRE_C.bg, uppercase: true, nowrap: true })] }),
      t({ data: "headline", font: "Poppins", weight: 700, size: 46, color: "#ffffff", align: "center" }),
      t({ data: "insight", font: "Poppins", weight: 400, size: 24, color: CHIFFRE_C.textDim, align: "center" })
    ]}),
    CHIFFRE_FOOTER_S1
  ]
);

layouts["tera-chiffremercredi-s2"] = chiffreRoot(
  ...
  113, [
    ...
    grp({ direction: "column", align: "center", gap: 24, children: [
      ...
      t({ data: "statistique", font: "Poppins", weight: 800, size: 130, color: CHIFFRE_C.accent, align: "center", nowrap: true, shadow: "0px 12px 30px rgba(0,0,0,0.16)" }),
      pill({ bg: "#ffffff", rotate: 2, padding: "10px 28px", children: [t({ data: "cartouche", font: "Poppins", weight: 800, size: 32, color: CHIFFRE_C.bg, uppercase: true, nowrap: true })] }),
      t({ data: "titre", font: "Poppins", weight: 700, size: 50, color: "#ffffff", align: "center", lineHeight: 1.08 }),
      t({ data: "texte", font: "Poppins", weight: 400, size: 24, color: CHIFFRE_C.textDim, align: "center", lineHeight: 1.45 })
    ]}),
    chiffreFooter("02 / 05 →")
  ]
);

layouts["tera-chiffremercredi-s3"] = chiffreRoot(
  { cx: 874.38, cy: 337.5, rx: 247, ry: 567, stops: ["rgba(23,54,122,1) 0%", "rgba(14,36,89,1) 50%", "rgba(4,18,56,1) 100%"] },
  [{ type: "circle", x: -120, y: 1000, w: 320, color: CHIFFRE_C.accent, opacity: 0.1 }],
  124, [
    CHIFFRE_HEADER,
    grp({ direction: "column", gap: 40, children: [
      ...
      t({ data: "titre", font: "Poppins", weight: 800, size: 56, color: "#ffffff", lineHeight: 1.02 }),
      grp({ direction: "column", gap: 32, children: [
        row({ gap: 16, align: "center", children: [
          ...
          grp({ direction: "column", gap: 8, children: [
            t({ data: "conseil1_titre", font: "Poppins", weight: 700, size: 34, color: "#ffffff" }),
            t({ data: "conseil1_texte", font: "Poppins", weight: 400, size: 24, color: CHIFFRE_C.textDim, lineHeight: 1.4 })
          ]})
        ]}),
        row({ gap: 16, align: "center", children: [
          { type: "circleBadge", size: 58, bg: CHIFFRE_C.accent, static: "2", font: "Poppins", weight: 800, textSize: 24, textColor: CHIFFRE_C.bg },
          grp({ direction: "column", gap: 8, children: [
            t({ data: "conseil2_titre", font: "Poppins", weight: 700, size: 34, color: "#ffffff" }),
            t({ data: "conseil2_texte", font: "Poppins", weight: 400, size: 24, color: CHIFFRE_C.textDim, lineHeight: 1.4 })
          ]})
        ]}),
        row({ gap: 16, align: "center", children: [
          { type: "circleBadge", size: 58, bg: CHIFFRE_C.accent, static: "3", font: "Poppins", weight: 800, textSize: 24, textColor: CHIFFRE_C.bg },
          grp({ direction: "column", gap: 8, children: [
            t({ data: "conseil3_titre", font: "Poppins", weight: 700, size: 34, color: "#ffffff" }),
            t({ data: "conseil3_texte", font: "Poppins", weight: 400, size: 24, color: CHIFFRE_C.textDim, lineHeight: 1.4 })
          ]})
        ]})
      ]})
    ]}),
